...
var MasterConfig = function() {
    var t = {
        ...
        basePageUrl:"https://uat.e-shequ.com/yueshenghuo/weixin/",
        payPageFolder:"http://uat.e-shequ.com/pay/",
        payPageSuffix:"wangdu",
...
function toRegisterAndBack(){
    ...
    location.href=MasterConfig.C('basePageUrl')+"home/index.html?#/register?comeFrom="+encodeURIComponent(n);
}
...
let common = {
    ...
    setCityName:function (cityName){
        var duration = new Date().getTime()/1000 + 3600*24*30;
        setCookie("cityName",cityName,duration);
    },
    getCityName:function (){
        var cityName = getCookie("cityName");
        return cityName;
    },
    HasCityName:function(){
        var cityName =  getCookie("cityName");
        // document.cookie.indexOf(“cityName=”)
        if(document.cookie.indexOf("cityName=")==-1){
            return false
        }else{
            return true
        }
